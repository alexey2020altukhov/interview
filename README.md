...
| Можно предоставлять реализацию методов по умолчанию | Разрешено только объявлять методы, но реализация их запрещена. Начиная с Java 8 стала допустима реализация методов посредством ключевого слова default |
