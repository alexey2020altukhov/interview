## Открытие страницы Swagger UI# Собеседование Junior+
## Дописать вопросы на темы:
- ODM
- Многопоточность
- Уровни изолированности
- @Component - кандидат на то, чтобы его зависимость положили на ApplicationContext
...
``@RequestBody`` сопоставляет тело HttpRequest с объектом transfer или domain и автоматическую десериализацию входящего тела HttpRequest в объект Java.
...
Уровни изолированности БД (дописать!)
...
**Iterable** - позволяет пользователям последовательно перебирать элементы из коллекции.
...
**Ограничения** - pk, fk, unique, not null, default, check, index.
